...
Phase 1 の内容は `01-Phase1全体ガイド.md`〜`05-ログイン画面実装手順.md` を参照してください。
...
| Step | 内容 | 主な成果物 |
|------|------|------------|
| 5 | 共有金額入力画面 | `/expense`、円グラフ・ジャンル選択・金額入力・登録ボタン |
| 6 | 個人家計簿画面 | `/ledger`、詳細エリア |
| 7 | 共有家計簿画面 | `/shared`、詳細(履歴) |
| 8 | ログイン・新規登録 API 連携 | 認証 API 呼び出し・トークン・遷移 |
| 9 | 認証状態・リダイレクト | 保護ルート・未ログイン時のリダイレクト |
| 10 | その他（任意） | スプラッシュスキップ・バリデーション等 |
...
API 仕様は `07-API仕様書.md`、DB 設計は `08-SQLite移管計画.md` を参照してください。
